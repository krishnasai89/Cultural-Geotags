...
export default function ThreeBackground() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // ✅ FIX: Use the native high-precision performance browser timestamp core.
      // Converts milliseconds into clean seconds delta parameters.
      const elapsedTime = performance.now() * 0.001;

      targetX += (mouseX - targetX) * 0.05;
      targetY += (mouseY - targetY) * 0.05;

      particleGlobe.rotation.y = elapsedTime * 0.05 + targetX;
      particleGlobe.rotation.x = elapsedTime * 0.02 + targetY;
