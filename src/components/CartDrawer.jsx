          ...
          {cart.length === 0 ? (
            ...
            <div className="flex flex-col gap-4 overflow-y-auto max-h-[65vh] pr-2 scrollbar-none">
              {cart.map((item, index) => (
                <div
                  key={`${item.id}-${index}`}
                  className="flex gap-4 p-3 rounded-xl border border-white/5 bg-slate-950/40 items-center justify-between animate-slide-up"
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="mt-1 inline-flex items-center gap-1.5 bg-white/[0.03] border border-white/5 px-2 py-0.5 rounded text-[10px] text-slate-400">
